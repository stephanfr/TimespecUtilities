...
TEST_CASE("TimeSpec tests", "[basic]")
{
    ...
    SECTION("Addition Tests")
    {
        ...
        {
            struct timespec test_time1 = 1_s;
            const struct timespec test_time2 = 1_s;

            test_time1 += test_time2;

            REQUIRE(test_time1.tv_sec == 2);
            REQUIRE(test_time1.tv_nsec == 0);
        }

        {
            ...
            REQUIRE(test_time1.tv_sec == 9);
            REQUIRE(test_time1.tv_nsec == 149999999);
        }

        {
            struct timespec test_time1 = 1.5_s;
            const struct timespec test_time2 = 2.5_s;

            test_time1 += test_time2;

            REQUIRE(test_time1.tv_sec == 4);
            REQUIRE(test_time1.tv_nsec == 0);
        }
    }
    ...
    SECTION("Subtraction Tests")
    {
        ...
        {
            struct timespec test_time1 = 7_s;
            const struct timespec test_time2 = 2_s;

            test_time1 -= test_time2;

            REQUIRE(test_time1.tv_sec == 5);
            REQUIRE(test_time1.tv_nsec == 0);
        }

        {
            ...
            REQUIRE(test_time1.tv_sec == 0);
            REQUIRE(test_time1.tv_nsec == 499999999);
        }

        {
            struct timespec test_time1 = 2_s;
            const struct timespec test_time2 = {1, 1};

            test_time1 -= test_time2;

            REQUIRE(test_time1.tv_sec == 0);
            REQUIRE(test_time1.tv_nsec == 999999999);
        }
    ...
    SECTION("Multiplication Tests")
    {
...

        {
            ...
            REQUIRE(test_time1.tv_sec == 14);
            REQUIRE(test_time1.tv_nsec == 0);
        }
                
        {
            struct timespec test_time1 = 7.5_s;

            test_time1 *= 2UL;

            REQUIRE(test_time1.tv_sec == 15);
            REQUIRE(test_time1.tv_nsec == 0);
        }
                
        {
            struct timespec test_time1 = 10.2_s;

            test_time1 *= 0.1;

            REQUIRE(test_time1.tv_sec == 1);
            REQUIRE(test_time1.tv_nsec == 19999999);
        }
    }
}